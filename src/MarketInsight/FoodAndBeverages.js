    	...
    	<div class="auto-container">
			<div class="clearfix">
                ...
                <div class="pull-right">
					<h6 style={{color:"white",fontWeight:"bold"}} ><a href="/" style={{color:"white",fontWeight:"bold"}}>Home</a> - <span>Market Insights </span> - <span>Food And Beverages</span></h6>
				</div>
				{/* <div class="pull-right">
					<ul class="page-br/eadcrumb">
						<li><a href="/">Home</a></li>
						<li><a href="#">Market Insights</a></li>
						<li class="current">Food And Beverages</li>
					</ul>
				</div> */}
			</div>
        </div>
                   	...
                   	<aside class="sidebar">
                        ...
                        <div class="sidebar-widget category-widget">
							...
							<ul class="cat-list">
								...
								<li class="active"><a href="food-and-beverages.php">Food & Beverages</a></li>
                ...
                <div class="content-side col-lg-8 col-md-12 col-sm-12">
                    ...
                    <div class="services-single">
						<div class="inner-box">
							...
							{/* <!-- Food And Beverages Reports List --> */}
