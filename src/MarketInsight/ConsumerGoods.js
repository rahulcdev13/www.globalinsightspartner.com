    	...
    	<div class="auto-container">
			<div class="clearfix">
                ...
                <div class="pull-right">
					<h6 style={{color:"white",fontWeight:"bold"}} ><a href="/" style={{color:"white",fontWeight:"bold"}}>Home</a> - <span>Market Insights </span> - <span>Consumer Goods</span></h6>
				</div>
				{/* <div class="pull-right">
					<ul class="page-br/eadcrumb">
						<li><a href="/">Home</a></li>
						<li><a href="#">Market Insights</a></li>
						<li class="current">Consumer Goods</li>
					</ul>
				</div> */}
			</div>
        </div>
                   	...
                   	<aside class="sidebar">
                        ...
                        <div class="sidebar-widget category-widget">
							...
							<ul class="cat-list">
								...
								<li class="active"><a href="/ConsumerGoods">Consumer Goods</a></li>
