    	...
    	<div class="auto-container">
			<div class="clearfix">
                ...
                <div class="pull-right">
					<h6 style={{color:"white",fontWeight:"bold"}} ><a href="/" style={{color:"white",fontWeight:"bold"}}>Home</a> - <span>Market Insights </span> - <span>Machines And Equipment</span></h6>
				</div>
				{/* <div class="pull-right">
					<ul class="page-br/eadcrumb">
						<li><a href="/">Home</a></li>
						<li><a href="#">Market Insights</a></li>
						<li class="current">Machines And Equipment</li>
					</ul>
				</div> */}
			</div>
        </div>
                   	...
                   	<aside class="sidebar">
                        ...
                        <div class="sidebar-widget category-widget">
							...
							<ul class="cat-list">
								...
								<li class="active"><a href="machines-and-equipment.php">Machines & Equipment</a></li>
                ...
                <div class="content-side col-lg-8 col-md-12 col-sm-12">
                    ...
                    <div class="services-single">
						<div class="inner-box">
							...
							{/* <!-- Machines And Equipment Reports List --> */}
