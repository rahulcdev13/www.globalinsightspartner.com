...
const ElectronicsAndSemiconductor = () => {
  return (
    <div>
    {/* <!--Page Title--> */}
  <section class="page-title" style={{backgroundImage:"url(assets/images/background/1.png)"}}>
      ...
      <div class="auto-container">
          <div class="clearfix">
              <div class="pull-left">
                  <h2>Electronics And Semiconductor</h2>
              </div>
              <div class="pull-right">
                  <h6 style={{color:"white",fontWeight:"bold"}} ><a href="/" style={{color:"white",fontWeight:"bold"}}>Home</a> - <span>Market Insights </span> - <span>Electronics And Semiconductor</span></h6>
              </div>
              {/* <div class="pull-right">
                  <ul class="page-br/eadcrumb">
                      <li><a href="/">Home</a></li>
                      <li><a href="#">Market Insights</a></li>
                      <li class="current">Electronics And Semiconductor</li>
                  </ul>
              </div> */}
          </div>
      </div>
                     ...
                     <aside class="sidebar">
                      ...
                      <div class="sidebar-widget category-widget">
                          ...
                          <ul class="cat-list">
                              ...
                              <li class="active"><a href="electronics-and-semiconductor.php">Electronics & Semiconductor</a></li>
                          </ul>
                      </div>
              ...
              <div class="content-side col-lg-8 col-md-12 col-sm-12">
                  ...
                  <div class="services-single">
                      <div class="inner-box">
                          ...
                          {/* <!-- Electronics And Semiconductor Reports List --> */}
...
export default ElectronicsAndSemiconductor
